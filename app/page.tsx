...
const QS = [
  {
    ...
    opts: [
      ...
      },
      {
        ...
        icon: "💨",
        ar: ["eucalipto", "hierba_buena", "melissa", "limon_persa"],
      },
    ],
  },
  {
    ...
    opts: [
      {
        ...
        desc: "Café y calma",
        icon: "☀️",
        ar: ["bergamota", "limon_persa", "neroli", "melissa"],
      },
      {
  ...
  },
  {
    ...
    opts: [
      ...
      },
      {
        ...
        desc: "Suave y sereno",
        icon: "🧘",
        ar: ["lavanda", "neroli", "flor_de_azahar", "melissa"],
      },
    ],
  },
  {
    ...
    opts: [
      {
        ...
        icon: "🛁",
        ar: ["eucalipto", "lavanda", "bergamota", "neroli"],
      },
      {
        label: "El dormitorio",
      ...
      },
      {
        ...
        icon: "🌿",
        ar: ["melissa", "bergamota", "limon_persa", "hierba_buena"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    opts: [
      ...
      },
      {
        ...
        icon: "🌊",
        ar: ["eucalipto", "bergamota", "hierba_buena", "melissa"],
      },
    ],
  },
];
...
const CATS: Record<string, string[]> = {
  ...
  Frescos: ["eucalipto", "hierba_buena", "melissa", "limon_persa", "bergamota", "maracuya", "manzana_verde", "mix_berries"],
